...
/**
 * Manager of processors<br> Maintains the relationship between command and command processor through command code.
 *
 * @author jiangping
...
public class ProcessorManager {
    ...
    /**
     * Get the specific processor with command code of cmdCode if registered, otherwise the default processor is
     * returned.
     */

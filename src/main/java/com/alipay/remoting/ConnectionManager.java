...
public interface ConnectionManager extends Scannable, LifeCycle {
    ...
    /**
     * Add a connection to {@link ConnectionPool}. If it contains multiple pool keys, this connection will be added to
     * multiple {@link ConnectionPool} too.
     *
     ...
     *
     * @param poolKey unique key of a {@link ConnectionPool}
     * @return a {@link Connection} selected by {@link ConnectionSelectStrategy}<br> or return {@code null} if there is
     * no {@link ConnectionPool} mapping with poolKey<br> or return {@code null} if there is no {@link Connection} in
     * {@link ConnectionPool}.
     */
    ...
    /**
     * Remove and close all connections from all {@link ConnectionPool}. Deprecated, use shutdown instead.
     */
    @Deprecated
    void removeAll();
    ...
    /**
     * This method can create connection pool with connections initialized and check the number of connections. The
     * connection number of {@link ConnectionPool} is decided by {@link Url#getConnNum()}. Each time call this method,
     * will check the number of connection, if not enough, this will do the healing logic additionally.
     */

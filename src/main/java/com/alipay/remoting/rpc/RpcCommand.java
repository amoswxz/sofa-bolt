...
/**
 * Remoting command. <br> A remoting command stands for a kind of transfer object in the network communication layer.
 *
 * @author jiangping
...
public abstract class RpcCommand implements RemotingCommand {
    ...
    private byte type;
    /**
     * Serializer, see the Configs.SERIALIZER_DEFAULT for the default serializer. Notice: this can not be changed after
     ...
     * <li>If mask <= {@link RpcDeserializeLevel#DESERIALIZE_ALL}, deserialize clazz, header and content - all three
     * parts.</li>
     * </ol>
     */

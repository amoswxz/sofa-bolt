...
/**
 * Extends this to process user defined request in SYNC way.<br> If you want process reqeuest in ASYNC way, please
 * extends {@link AsynMultiInterestUserProcessor}.
 *
...
public abstract class SyncMutiInterestUserProcessor<T> extends
    ...
    /**
     * @see com.alipay.remoting.rpc.protocol.UserProcessor#handleRequest(com.alipay.remoting.BizContext,
     * java.lang.Object)
     */
    @Override
     ...
     *
     * @see com.alipay.remoting.rpc.protocol.UserProcessor#handleRequest(com.alipay.remoting.BizContext,
     * com.alipay.remoting.AsyncContext, java.lang.Object)
     */
    @Override

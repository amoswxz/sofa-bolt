...
/**
 * Extends this to process user defined request in ASYNC way.<br> If you want process reqeuest in SYNC way, please
 * extends {@link SyncMutiInterestUserProcessor}.
 *

...
public class RpcRequestProcessor extends AbstractRemotingProcessor<RpcRequestCommand> {
    ...
    /**
     * @see com.alipay.remoting.AbstractRemotingProcessor#process(com.alipay.remoting.RemotingContext,
     * com.alipay.remoting.RemotingCommand, java.util.concurrent.ExecutorService)
     */
    @Override
    ...
    /**
     * @see com.alipay.remoting.AbstractRemotingProcessor#doProcess(com.alipay.remoting.RemotingContext,
    ...
    /**
     * Send response using remoting context if necessary.<br> If request type is oneway, no need to send any response
     * nor exception.
     *
    ...
    public void sendResponseIfNecessary(final RemotingContext ctx, byte type,
        ...
        if (type != RpcCommandType.REQUEST_ONEWAY) {
            ...
            try {
                ...
                String errMsg =
                        "SerializationException occurred when sendResponseIfNecessary in RpcRequestProcessor, id="
                                + id;
                ...
                String errMsg =
                        "Serialize RpcResponseCommand failed when sendResponseIfNecessary in RpcRequestProcessor, id="
                                + id;

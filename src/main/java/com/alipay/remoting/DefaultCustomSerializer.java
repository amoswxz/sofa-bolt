...
public class DefaultCustomSerializer implements CustomSerializer {
    ...
    /**
     * @see com.alipay.remoting.CustomSerializer#deserializeHeader(com.alipay.remoting.rpc.ResponseCommand,
     * InvokeContext)
     */
    @Override
    ...
    /**
     * @see com.alipay.remoting.CustomSerializer#deserializeContent(com.alipay.remoting.rpc.ResponseCommand,
     * InvokeContext)
     */
    @Override

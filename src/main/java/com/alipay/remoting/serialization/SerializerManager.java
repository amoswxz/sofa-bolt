 ...
 *
 * Notice: Serializer is different with Codec. Serializer is mainly used to deserialize bytes to object, or serialize
 * object to bytes. We can use hessian, json, protocol buff etc. Codec mainly used to encode bytes or decode bytes
 * according to the protocol format. We can use {@link com.alipay.remoting.codec.ProtocolCodeBasedEncoder} or {@link
 * io.netty.handler.codec.LengthFieldBasedFrameDecoder} etc.
 *
 * @author jiangping
